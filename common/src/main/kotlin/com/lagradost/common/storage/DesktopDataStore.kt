...
object DesktopDataStore {
    ...
    // In-memory cache of the JSON map
    ...
    val historyUpdates = kotlinx.coroutines.flow.MutableStateFlow(0)
    val pluginUpdatesFlow = kotlinx.coroutines.flow.MutableStateFlow(0)
